...
- (void)viewDidLoad
{
	...
	self.backBtn.image		= [UIImage imageNamed:[[self class] resolveImageResource:@"___FILEBASENAME___.bundle/arrow_left"]];
	self.fwdBtn.image		= [UIImage imageNamed:[[self class] resolveImageResource:@"___FILEBASENAME___.bundle/arrow_right"]];
	self.safariBtn.image	= [UIImage imageNamed:[[self class] resolveImageResource:@"___FILEBASENAME___.bundle/compass"]];
